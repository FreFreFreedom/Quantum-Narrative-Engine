...
Status: DESIGN OPTIONS, 2026-09-18. Not authorization to change the live Room layout.
...
No option chosen yet. On narrow screens, use the existing overlay behavior rather
