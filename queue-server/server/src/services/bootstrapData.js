...
const KNOWLEDGE_DESCRIPTIONS = {
  ...
  'fractal_operational_core.md': 'The operational extension of ontology.md §1: what an entity is (self-maintenance, internal fragmentation), why entity and event are the same kind of thing, the three layers as three acts, the platform as a prosthetic analogical layer, mechanisms for integration and shadow, the three navigation moves (vertical/horizontal/entanglement), a grouped list of real-world projects working each layer, and a reading list with difficulty marks. Append to this file rather than re-deriving the vision in chat.',
};
